...
const shippedOrdersResolver = {
    Query: {
        getShippedOrders: (_, { searchQuery, limit, offset, platform }, context) => __awaiter(void 0, void 0, void 0, function* () {
            const clause = {
                where: {},
            };
            if (context.roleId === 4) {
    ...
    Mutation: {
        changeToShipped: (_, { order_id }, context) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.default = shippedOrdersResolver;
