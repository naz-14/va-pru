...
const localOrdersResolver = {
    Query: {
        getLocalOrders: (_, { searchQuery, limit, offset, platform }, context) => __awaiter(void 0, void 0, void 0, function* () {
            const clause = {
                where: {
                    type_id: 2,
                },
...
exports.default = localOrdersResolver;
