...
const toStockOrdersResolver = {
    Query: {
        getToStockOrders: (_, { searchQuery, limit, offset, platform }, context) => __awaiter(void 0, void 0, void 0, function* () {
            const clause = {
                where: { status_id: 6 },
            };
            if (context.storeId) {
    ...
    Mutation: {
        changeToSupply: (_, { order_id }, context) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.default = toStockOrdersResolver;
